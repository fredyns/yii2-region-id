...
<div class="giiant-crud kecamatan-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'Kecamatan'=>$copyParams],
    ...
    <?php $this->beginBlock('fredyns\daerahIndonesia\models\Kecamatan'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            '<span class="glyphicon glyphicon-list"></span> ' . 'List All' . ' Kelurahans',
            ['kelurahan/index'],
...
</div></div><?php Pjax::begin(['id'=>'pjax-Kelurahans', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-Kelurahans ul.pagination a, th a', 'clientOptions' => ['pjax:success'=>'function(){alert("yo")}']]) ?>
<?= '<div class="table-responsive">' . \yii\grid\GridView::widget([
    'layout' => '{summary}{pager}<br/>{items}{pager}',
    'dataProvider' => new \yii\data\ActiveDataProvider(['query' => $model->getKelurahans(), 'pagination' => ['pageSize' => 20, 'pageParam'=>'page-kelurahans']]),
    'pager'        => [
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['kodepos/create', 'Kodepos' => ['kecamatan_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['fredyns\daerahIndonesia\models\Kecamatan'],
    'active'  => true,
],[
