...
<div class="giiant-crud kota-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'Kota'=>$copyParams],
    ...
    <?php $this->beginBlock('fredyns\daerahIndonesia\models\Kota'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            '<span class="glyphicon glyphicon-list"></span> ' . 'List All' . ' Kecamatans',
            ['kecamatan/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . 'New' . ' Kecamatan',
            ['kecamatan/create', 'Kecamatan' => ['kota_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div></div><?php Pjax::begin(['id'=>'pjax-Kecamatans', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-Kecamatans ul.pagination a, th a', 'clientOptions' => ['pjax:success'=>'function(){alert("yo")}']]) ?>
<?= '<div class="table-responsive">' . \yii\grid\GridView::widget([
    'layout' => '{summary}{pager}<br/>{items}{pager}',
    'dataProvider' => new \yii\data\ActiveDataProvider(['query' => $model->getKecamatans(), 'pagination' => ['pageSize' => 20, 'pageParam'=>'page-kecamatans']]),
    'pager'        => [
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['kodepos/create', 'Kodepos' => ['kota_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['fredyns\daerahIndonesia\models\Kota'],
    'active'  => true,
],[
