...
<div class="giiant-crud provinsi-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'Provinsi'=>$copyParams],
    ...
    <?php $this->beginBlock('fredyns\daerahIndonesia\models\Provinsi'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            '<span class="glyphicon glyphicon-list"></span> ' . 'List All' . ' Kodepos',
            ['kodepos/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . 'New' . ' Kodepo',
            ['kodepos/create', 'Kodepos' => ['provinsi_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div></div><?php Pjax::begin(['id'=>'pjax-Kodepos', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-Kodepos ul.pagination a, th a', 'clientOptions' => ['pjax:success'=>'function(){alert("yo")}']]) ?>
<?= '<div class="table-responsive">' . \yii\grid\GridView::widget([
    'layout' => '{summary}{pager}<br/>{items}{pager}',
    'dataProvider' => new \yii\data\ActiveDataProvider(['query' => $model->getKodepos(), 'pagination' => ['pageSize' => 20, 'pageParam'=>'page-kodepos']]),
    'pager'        => [
...
<?php $this->beginBlock('Kotas'); ?>
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            '<span class="glyphicon glyphicon-list"></span> ' . 'List All' . ' Kotas',
            ['kota/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . 'New' . ' Kota',
            ['kota/create', 'Kota' => ['provinsi_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div></div><?php Pjax::begin(['id'=>'pjax-Kotas', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-Kotas ul.pagination a, th a', 'clientOptions' => ['pjax:success'=>'function(){alert("yo")}']]) ?>
<?= '<div class="table-responsive">' . \yii\grid\GridView::widget([
    'layout' => '{summary}{pager}<br/>{items}{pager}',
    'dataProvider' => new \yii\data\ActiveDataProvider(['query' => $model->getKotas(), 'pagination' => ['pageSize' => 20, 'pageParam'=>'page-kotas']]),
    'pager'        => [
        'class'          => yii\widgets\LinkPager::className(),
        'firstPageLabel' => 'First',
        'lastPageLabel'  => 'Last'
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['fredyns\daerahIndonesia\models\Provinsi'],
    'active'  => true,
],[
